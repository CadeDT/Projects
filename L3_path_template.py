...
motions = [
    [0.0, -pi/4, 2.0],          # Motion 1
    [0.3, 0.0, 1.0],            # Motion 2
    [0.0, pi/4, 2.0],           # Motion 3
    [0.3, 0.0, 0.75],           # Motion 4
    [0.0, pi/4, 2.0],           # Motion 5
    [0.3, 0.0, 1.0],            # Motion 6
    [0.0, -pi/4, 2.0],          # Motion 7
    [0.3, 0.0, 0.75],           # Motion 8
    [0.0, -pi/4, 2.0],          # Motion 9
    [0.3, 0.0, 1.0],            # Motion 10
]
...
for  count, motion in enumerate(motions):
    ...
    log.tmpFile(motion[0],"fvelocity.txt")
    log.tmpFile(motion[1],"avelocity.txt")
